...
import aiansImage from "../assets/ai-ans.png"
          ...
          <div className="text-center mb-28">
            ...
            transition={{duration: 0.6}}
             className='text-gray-500 mt-6 max-w-2xl mx-auto text-lg'>
              Roled-Based mock Interviews with smart follow-ups, 
              ...
              [
                ...
                ${index == 2 ? "-rotate-3" : ""}`}>
                  ...
                  <div className="pt-10 text-center">
                    ...
                    mb-6 tracking-wider'>{item.step}</div>
                  ...
                  p-8 shadow-sm hover:shadow-xl transition-all">
                    ...
                    gap-8">
                      ...
                      <div className="w-full md:w-1/2">
                        ...
                        rounded-xl flex justify-center items-center mb-6">
                          {item.icon}
                        </div>
